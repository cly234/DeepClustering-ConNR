...
class TrainTask(object):
    ...
    def build_default_options():
        ...
        parser.add_argument('--pretrain_epochs', type=int, default=800, help='number of epochs needed for pretraining')
        ...
        parser.add_argument('--data_folder', type=str, default='../autodl-tmp',
        ...
        parser.add_argument('--resized_crop_scale_ft', type=float, help='randomresizedcrop scale for ft', default=0.45)
    ...
    def create_dataset(data_root, dataset_name, train, transform=None, memory=False, label_file=None,
        ...
        if dataset_name in ['cifar10', 'cifar20', 'cifar100']:
            ...
            has_subfolder = True
            dataset = dataset_type(data_root, train, transform, download=False)
    ...
    def train_transform(self, normalize):
        ...
        train_transform = [
            transforms.RandomResizedCrop(size=opt.img_size, scale=(opt.resized_crop_scale_ft if opt.resume_epoch >= opt.pretrain_epochs or self.cur_epoch > opt.pretrain_epochs else opt.resized_crop_scale, 1.)),
    ...
    def fit(self):
        ...
        while True:
            ...
            if  (self.cur_epoch % opt.save_freq == 0):
            ...
            if opt.resume_epoch < opt.pretrain_epochs and self.cur_epoch > opt.pretrain_epochs:
                self.set_loader()
